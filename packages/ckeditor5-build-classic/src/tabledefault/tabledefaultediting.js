...
/**
 * @module table/tabledefault/tabledefaultediting
 */
 ...
 */
export default class TableDefaultEditing extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get pluginName() {
		return 'TableDefaultEditing';
	}

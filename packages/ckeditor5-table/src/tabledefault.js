...
/**
 * @module table/tabledefault
 */

import Plugin from '@ckeditor/ckeditor5-core/src/plugin';

import TableDefaultEditing from './tabledefault/tabledefaultediting';
import TableDefaultUI from './tabledefault/tabledefaultui';
 ...
 * {@link module:table/tabledefault/tabledefaultediting~TableDefaultEditing table properties editing feature} and
 * the {@link module:table/tabledefault/tabledefaultui~TableDefaultUI table properties UI feature}.
 *
 * @extends module:core/plugin~Plugin
 */
export default class TableDefault extends Plugin {
	/**
	 * @inheritDoc
	 */
	 ...
	 */
	static get requires() {
		return [ TableDefaultEditing, TableDefaultUI ];
	}
}
 ...
 *
 * @member {Object} module:table/table~TableConfig#tableDefault
 */

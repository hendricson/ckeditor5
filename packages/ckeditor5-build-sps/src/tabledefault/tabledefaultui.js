...
/**
 * @module table/tabledefault/tabledefaultui
 */
...
import TableDefaultView from './ui/tabledefaultview';
import tableProperties from './../../theme/icons/table-properties.svg';

const tableDefault = tableProperties;
...
/**
 * The table properties UI plugin. It introduces the `'tableDefault'` button
 ...
 */
export default class TableDefaultUI extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get requires() {
	...
	constructor( editor ) {
		...
		editor.config.define( 'table.tableDefault', {
	...
	init() {
		 ...
		 *
		 * @member {module:table/tabledefault/ui/tabledefaultview~TableDefaultView}
		 */
		...
		editor.ui.componentFactory.add( 'tableDefault', locale => {
	...
	/**
	 * Creates the {@link module:table/tabledefault/ui/tabledefaultview~TableDefaultView} instance.
	 *
	 * @private
	 * @returns {module:table/tabledefault/ui/tabledefaultview~TableDefaultView} The table
	 * properties form view instance.
	 */
	_createDefaultView() {
		const editor = this.editor;
		const viewDocument = editor.editing.view.document;
		const config = editor.config.get( 'table.tableDefault' );
		const borderColorsConfig = normalizeColorOptions( config.borderColors );
		const localizedBorderColors = getLocalizedColorOptions( editor.locale, borderColorsConfig );
		const backgroundColorsConfig = normalizeColorOptions( config.backgroundColors );
		const localizedBackgroundColors = getLocalizedColorOptions( editor.locale, backgroundColorsConfig );
		const view = new TableDefaultView( editor.locale, {
